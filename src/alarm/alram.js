...
const photoCardNotifications = [
  {
    endpoint: '/api/photo-card-exchange-success',
    message: '포토 카드 교환 제안이 승인되었습니다.',
    type: 'PHOTO_CARD_EXCHANGE_SUCCESS',
  },
  {
    endpoint: '/api/photo-card-exchange-proposal',
    message: '포토 카드 교환 제안이 왔습니다.',
    type: 'PHOTO_CARD_EXCHANGE_PROPOSAL',
  },
  {
    endpoint: '/api/photo-card-purchase-complete',
    message: '포토 카드 구매가 완료되었습니다.',
    type: 'PHOTO_CARD_PURCHASE_COMPLETE',
  },
  {
    endpoint: '/api/photo-card-sale-success',
    message: '포토 카드가 판매되었습니다.',
    type: 'PHOTO_CARD_SALE_SUCCESS',
  },
  {
    endpoint: '/api/photo-card-out-of-stock',
    message: '판매 중인 포토 카드가 품절되었습니다.',
    type: 'PHOTO_CARD_OUT_OF_STOCK',
  },
];
